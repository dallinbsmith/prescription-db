...
const debugBluechew = async () => {
  ...
  const urls = [
    ...
    'https://www.bluechew.com/plans',
    'https://www.bluechew.com/sildenafil',
    'https://www.bluechew.com/tadalafil',
  ];
  ...
  for (const url of urls) {
    ...
    try {
      ...
      const data = await page.evaluate(() => {
        ...
        const drugKeywords = [
          'sildenafil', 'tadalafil', 'vardenafil', 'viagra', 'cialis', 'levitra',
          'chewable', 'tablet'
        ];
        ...
        return { 
          links: links.filter(l => 
            l.href?.includes('sildenafil') || 
            l.href?.includes('tadalafil') || 
            l.href?.includes('vardenafil') ||
            l.href?.includes('plan') ||
